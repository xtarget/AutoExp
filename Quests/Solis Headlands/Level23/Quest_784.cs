...
{
    internal class Quest_784 : Quest
    {
        public Quest_784(int minLvl, int maxLvl, QuestRace race, uint[] reqQuests)
            : base(784, minLvl, maxLvl, race, reqQuests)
        { }
        ...
        public override bool RunQuest(Host host)
        {
            ...
            if (quest != null && quest.status == QuestStatus.Accepted)
            {
                ...
                if (!host.movementModule.GpsMove("Quest_784_1"))
                    return false;
                host.farmModule.SetFarmDoodads(zone, new uint[] { 4250 });

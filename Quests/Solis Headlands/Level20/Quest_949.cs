        ...
        public override bool RunQuest(Host host)
        {
            ...
            if (quest != null && quest.status == QuestStatus.Accepted)
            {
                if (quest.steps[0] == 0)
                {
                    ...
                    Thread.Sleep(1000);
                    host.farmModule.UseDoodadSkill(12876, host.getNearestDoodad(2029), true);
                    Thread.Sleep(1000);
                }
                if (quest.steps[2] == 0)
                {
                    ...
                    Thread.Sleep(1000);
                    host.farmModule.UseDoodadSkill(12879, host.getNearestDoodad(2030), true);
                    Thread.Sleep(1000);
                }
                if (quest.steps[1] == 0)
                {
                    ...
                    Thread.Sleep(1000);
                    host.farmModule.UseDoodadSkill(12880, host.getNearestDoodad(2042), true);
                    Thread.Sleep(1000);
                }
                if (quest.steps[3] == 0)
                {
                    ...
                    Thread.Sleep(1000);
                    host.farmModule.UseDoodadSkill(12878, host.getNearestDoodad(2031), true);
                    Thread.Sleep(1000);
                }
            }

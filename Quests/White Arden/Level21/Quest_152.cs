...
{
    internal class Quest_152 : Quest
    {
        public Quest_152(int minLvl, int maxLvl, QuestRace race, uint[] reqQuests)
            : base(152, minLvl, maxLvl, race, reqQuests)
        { }
        ...
        public override bool RunQuest(Host host)
        {
            ...
            if (!checkQuestCompletedOrPerfomed(151))
                return false;

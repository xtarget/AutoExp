...
{
    //
    internal class Quest_842 : Quest
    {
        public Quest_842(int minLvl, int maxLvl, QuestRace race, uint[] reqQuests)
            : base(842, minLvl, maxLvl, race, reqQuests)
        { }
        ...
        public override bool RunQuest(Host host)
        {
            ...
            if (quest != null && quest.status == QuestStatus.Accepted)
            {
                ...
                if (!host.movementModule.GpsMove("Quest_842_1"))
                    return false;
                host.farmModule.SetFarmMobs(zone, new uint[] { 5012 });

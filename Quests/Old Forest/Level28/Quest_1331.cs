...
{
    //
    internal class Quest_1331 : Quest
    {
        public Quest_1331(int minLvl, int maxLvl, QuestRace race, uint[] reqQuests)
            : base(1331, minLvl, maxLvl, race, reqQuests)
        { }
        ...
        public override bool RunQuest(Host host)
        {
            ...
            if (quest != null && quest.status == QuestStatus.Accepted)
            {
                ...
                if (!host.movementModule.GpsMove("Quest_1337_1"))
                    return false;
                host.farmModule.SetFarmMobs(zone, new uint[] { 3115 });

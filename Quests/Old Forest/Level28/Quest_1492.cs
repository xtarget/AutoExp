...
namespace AutoExp.Quests
{
    ...
    internal class Quest_1492 : Quest
    {
        ...
        public override bool RunQuest(Host host)
        {
            ...
            {
                host.farmModule.UseItemAndWait(14321);
                Thread.Sleep(500);
                host.farmModule.UseItemAndWait(14403);
                Thread.Sleep(500);
                host.farmModule.UseItemAndWait(23620);
                Thread.Sleep(500);
                if (!host.movementModule.GpsMove("Quest_1492_1"))
                    return false;
                Thread.Sleep(1000);
                host.farmModule.UseDoodadSkill(13694, host.getNearestDoodad(3203), true);
                Thread.Sleep(1000);
            }

    ...
    internal class Quest_1303 : Quest
    {
        ...
        public override bool RunQuest(Host host)
        {
            ...
            if (quest != null && quest.status == QuestStatus.Accepted)
            {
                ...
                while (host.farmModule.readyToActions && host.farmModule.farmState == Modules.FarmState.Doodads && quest.status == QuestStatus.Accepted && host.farmModule.getDoodadsCountInZone(zone, 2761) > 0)
                    Thread.Sleep(100);

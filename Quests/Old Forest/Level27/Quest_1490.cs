    ...
    internal class Quest_1490 : Quest
    {
        ...
        public override bool RunQuest(Host host)
        {
            ...
            if (quest != null && quest.status == QuestStatus.Accepted)
            {
                ...
                host.farmModule.UseDoodadSkill(13693, host.getNearestDoodad(5462), true);
                Thread.Sleep(1000);
                host.farmModule.UseDoodadSkill(13693, host.getNearestDoodad(2511), true);
                Thread.Sleep(1000);
                host.farmModule.UseDoodadSkill(13693, host.getNearestDoodad(5465), true);
                Thread.Sleep(1000);
                
                if (host.itemCount(14527) > 0 && host.itemCount(14528) > 0 && host.itemCount(14317) > 0)
                    host.farmModule.UseItemAndWait(14527);
                Thread.Sleep(1000);
            }

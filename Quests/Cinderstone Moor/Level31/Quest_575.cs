...
{
    //
    internal class Quest_575 : Quest
    {
        public Quest_575(int minLvl, int maxLvl, QuestRace race, uint[] reqQuests)
            : base(575, minLvl, maxLvl, race, reqQuests)
        { }
        ...
        public override bool RunQuest(Host host)
        {
            ...
            if (!checkQuestCompletedOrAccepted(584))
                return false;

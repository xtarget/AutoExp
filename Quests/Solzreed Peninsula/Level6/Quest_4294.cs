...
{
    //
    internal class Quest_4294 : Quest
    {
        public Quest_4294(int minLvl, int maxLvl, QuestRace race, uint[] reqQuests)
            : base(4294, minLvl, maxLvl, race, reqQuests)
        { }
        ...
        public override bool RunQuest(Host host)
        {
            ...
            if (quest != null && quest.status == ArcheBuddy.Bot.Classes.QuestStatus.Accepted)
            {
                ...
                RoundZone zone = new RoundZone(14870.49, 14263.85, 10);
                if (quest.steps[0] == 0)
                {

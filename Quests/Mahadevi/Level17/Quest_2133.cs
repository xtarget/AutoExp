...
{
    internal class Quest_2133 : Quest
    {
        public Quest_2133(int minLvl, int maxLvl, QuestRace race, uint[] reqQuests, uint[] reqUncompleteQuests)
            : base(2133, minLvl, maxLvl, race, reqQuests, reqUncompleteQuests)
        { }

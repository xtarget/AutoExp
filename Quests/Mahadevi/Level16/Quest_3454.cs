    ...
    internal class Quest_3454 : Quest
    {
        ...
        public override bool RunQuest(Host host)
        {
            ...
            if (quest.status == QuestStatus.Accepted)
            {
                ...
                while (host.farmModule.readyToActions && host.farmModule.farmState == Modules.FarmState.Enabled && quest.status == QuestStatus.Accepted && host.itemCount(21310) == 0)
                    Thread.Sleep(100);
                ...
                if (host.itemCount(21310) > 0)
                {
                    ...
                    if (c != null)
                    {
                        host.SetTarget(c);
                        Thread.Sleep(500);
                        host.farmModule.UseItemAndWait(21310);
                        Thread.Sleep(1000);
                    }
                }
            }

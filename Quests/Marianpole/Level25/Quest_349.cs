...
{
    internal class Quest_349 : Quest
    {
        public Quest_349(int minLvl, int maxLvl, QuestRace race, uint[] reqQuests)
            : base(349, minLvl, maxLvl, race, reqQuests)
        { }
        ...
        public override bool RunQuest(Host host)
        {
            ...
            if (!checkQuestCompletedOrPerfomed(184))
                return false;
            ...
            if (quest != null && quest.status == QuestStatus.Accepted)
            {
                ...
                if (!host.movementModule.GpsMove("Quest_178_1"))
                    return false;
                host.farmModule.SetFarmMobs(zone, new uint[] { 477 });

...
{
    internal class Quest_1622 : Quest
    {
        public Quest_1622(int minLvl, int maxLvl, QuestRace race, uint[] reqQuests)
            : base(1622, minLvl, maxLvl, race, reqQuests)
        { }
        ...
        public override bool RunQuest(Host host)
        {
            ...
            if (!checkQuestCompletedOrPerfomed(1619))
                return false;

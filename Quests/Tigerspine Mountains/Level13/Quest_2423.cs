    ...
    internal class Quest_2423 : Quest
    {
        ...
        public override bool RunQuest(Host host)
        {
            ...
            if (quest != null && quest.status == QuestStatus.Accepted)
            {
                ...
                host.Jump(true);
                while (host.me.Z < 380.65 && host.me.isAlive())
                    Thread.Sleep(10);
                host.Jump(false);
                ...
                if (host.me.Z < 382.65)
                {
                    ...
                    host.MoveForward(true);
                    host.Jump(true);
                    while (host.me.Z < 382.65 && host.me.isAlive())
                        Thread.Sleep(10);
                    host.Jump(false);
                    host.MoveForward(false);
                }
                if (host.me.Z < 384.60)
                {
                    ...
                    host.MoveForward(true);
                    host.Jump(true);
                    while (host.me.Z < 384.60 && host.me.isAlive())
                        Thread.Sleep(10);
                    host.Jump(false);
                    host.MoveForward(false);
                }
                ...
                host.MoveForward(true);
                host.Jump(true);
                while (host.me.Z < 386.31 && host.me.isAlive())
                    Thread.Sleep(10);
                host.Jump(false);
                host.MoveForward(false);
                ...
                host.farmModule.UseDoodadSkill(14053, host.getNearestDoodad(6533), true);
            }

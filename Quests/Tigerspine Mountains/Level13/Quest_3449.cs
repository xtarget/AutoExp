    ...
    internal class Quest_3449 : Quest
    {
        ...
        public override bool RunQuest(Host host)
        {
            ...
            if (quest != null && quest.status == QuestStatus.Accepted)
            {
                ...
                Thread.Sleep(1000);
                while (host.farmModule.readyToActions && quest.status == QuestStatus.Accepted && host.isAlive())
                {
                    host.farmModule.UseDoodadSkill(16792, host.getNearestDoodad(10474), true);
                    Thread.Sleep(1000);

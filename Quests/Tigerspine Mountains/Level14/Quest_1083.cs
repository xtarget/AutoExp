...
namespace AutoExp.Quests
{
    ...
    internal class Quest_1083 : Quest
    {
        ...
        public override bool RunQuest(Host host)
        {
            ...
            if (host.me.charRace == CharRace.Hariharan && !checkQuestCompletedOrPerfomed(3525))
                return false;
            ...
            if (quest != null && quest.status == QuestStatus.Accepted)
            {
                ...
                Thread.Sleep(1000);
                host.farmModule.UseDoodadSkill(11965, host.getNearestDoodad(2535), true);
                Thread.Sleep(18000);
                host.farmModule.UseDoodadSkill(19243, host.getNearestDoodad(2294), true);
                Thread.Sleep(1000);
            }
